...
Interactive CLI tool that retrieves official WMO weather forecasts for cities worldwide via external API integration.  
...
|---|---|---|
| CS50's Introduction to Artificial Intelligence with Python | Harvard / edX | 2026 |
| CS50's Introduction to Programming with Python | Harvard / edX | 2026 |
